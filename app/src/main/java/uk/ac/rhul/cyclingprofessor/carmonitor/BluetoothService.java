...
public class BluetoothService {
     ...
     * connections with an HC-05. It has a thread for connecting with the device, and a
    ...
    /**
     * Constructor. Prepares a new Bluetooth Comms session.
     *
    ...
    /**
     * Start the comms service. Called by the Activity onResume()
     */
